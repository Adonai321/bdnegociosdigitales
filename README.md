...
El `alumno` creará bases de datos relacionales y no relacionales a través de esquemas de **administración** y seguridad para manipular datos almacenados en la nube.

| Left columns  | Right columns |
| ------------- |:-------------:|
| I  | Gestion de Servidores|
| left bar      | right bar     |
| left baz      | right baz     |
...
![This is an alt text.](img/8ba73d35aa2654b6dfca2b8b6a2a3da5.jpg "Base de Datos para Negocios Digitales")

Puedes utilizar [Markdown Live Preview](https://markdownlivepreview.com/).
